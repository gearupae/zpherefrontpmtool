...
export default function EmailSettingsPage() {
 ...
 <span className={`px-2 text-xs rounded ${isConfigured ? 'bg-green-100 text-green-800 border border-green-300' : 'bg-yellow-100 text-yellow-800 border border-yellow-300'}`}>
 {isConfigured ? 'Configured' : 'Not Configured'}
 </span>
 <span className={`px-2 text-xs rounded ${isActive ? 'bg-blue-100 text-blue-800 border border-blue-300' : 'bg-gray-100 text-gray-700 border border-gray-300'}`}>

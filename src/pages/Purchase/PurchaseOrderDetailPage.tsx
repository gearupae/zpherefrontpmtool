...
const PurchaseOrderDetailPage: React.FC = () => {
 ...
 className="inline-flex items-center py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-white bg-primary-600 hover:bg-primary-700"
 >
 Save
 </button>
 <button
 onClick={() => { handleEditCancel(); setActiveTab('overview'); }}
 className="inline-flex items-center py-2 border border-gray-300 text-sm leading-4 font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50"
 >
 Cancel
 </button>
 </div>

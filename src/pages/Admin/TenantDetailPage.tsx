...
const TenantDetailPage: React.FC = () => {
 ...
 const baseClasses = 'text-sm font-medium rounded-full';
 switch (status) {
 case 'active':
 ...
 <span className={`px-2 text-xs font-medium rounded-full ${
 ...
 {module.is_core && (
 <span className="px-2 text-xs font-medium rounded-full bg-red-100 text-red-800">
 Required
 </span>
 )}
 </div>

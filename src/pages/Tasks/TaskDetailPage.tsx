              ...
              {isEditing ? (
                <div className="flex space-x-2">
                  ...
                  <button
                    ...
                    className="inline-flex items-center px-3 py-2 border border-secondary-300 text-sm font-medium rounded-md text-secondary-700 bg-white hover:bg-secondary-50"
                  >
                    Cancel
                  </button>
                </div>

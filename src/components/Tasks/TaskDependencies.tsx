...
const TaskDependencies: React.FC<TaskDependenciesProps> = ({
 ...
 className="flex items-center space-x-1 text-xs bg-blue-600 text-white rounded hover:bg-blue-700 transition-colors"
 >
 ...
 <span 
 className={`px-2 text-xs rounded border ${getTaskStatus(prerequisiteTask)}`}
 >
 ...
 <ArrowRightIcon className="h-4 w-4 text-user-red" />
 <span 
 className={`px-2 text-xs rounded border ${getTaskStatus(dependentTask)}`}
 >
 ...
 <span 
 className={`px-2 text-xs rounded border ${getTaskStatus(relatedTask)}`}
 >
 {relatedTask.status}
 </span>
 <span className="text-sm text-text-primary font-medium">
 ...
 className="w-full py-2 text-sm border border-border rounded-lg focus:ring-2 focus:ring-user-blue focus:border-transparent"
 >
 ...
 className="py-2 text-sm bg-blue-600 text-white rounded-lg hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
 >
 Add Dependency
 </button>
 <button
 onClick={() => setShowAddForm(false)}
 className="py-2 text-sm border border-border rounded-lg hover:bg-surface transition-colors"
 >
 Cancel
 </button>
 </div>

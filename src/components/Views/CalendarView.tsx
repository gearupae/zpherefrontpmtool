    ...
    if (type === 'mixed') {
      mixedEvents.forEach(ev => {
        ...
        allEvents.push({
          ...
          type: (ev.type as any) === 'goal' ? 'project' : (['task','project'].includes(ev.type as any) ? (ev.type as any) : 'project'),
              ...
              >
                ...
                <div className="space-y-1">
                  {dayEvents.slice(0, 3).map(event => (
                    <div
                      key={event.id}
onClick={() => onItemClick?.(event.id, (event.item as any).url)}

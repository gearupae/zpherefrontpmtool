...
const ThreadedComments: React.FC<ThreadedCommentsProps> = ({
 ...
 className="w-full text-left py-2 hover:bg-gray-100 flex items-center space-x-2"
 >
 ...
 className="text-sm bg-blue-600 text-white rounded hover:bg-blue-700 disabled:bg-gray-400"
 >
 Reply
 </button>
 </div>

...
const TeamManagement: React.FC<TeamManagementProps> = ({ currentUser, onTeamUpdate }) => {
 ...
 <span className={`inline-flex items-center px-2 rounded-full text-xs font-medium ${getRoleColor(member.role)}`}>
 {member.role}
 </span>
 ...
 <div className="flex items-center space-x-2">
 {hasRolePermission && (
 <span className="text-xs text-green-600 bg-green-100 px-2 rounded">
 Role
 </span>
 )}
 <input

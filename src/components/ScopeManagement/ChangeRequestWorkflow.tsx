...
const ChangeRequestList: React.FC<{
 ...
 <span className={`inline-flex items-center px-2 rounded text-xs font-medium ${getPriorityColor(request.priority)}`}>
 {request.priority}
 </span>
 </div>
...
const ChangeRequestDetail: React.FC<{
 ...
 className={`flex items-center space-x-2 py-3 font-medium text-sm rounded-md transition-colors focus:outline-none focus:ring-0 ${

            ...
            <div className="flex items-start justify-between mb-4">
              <div className="flex-1">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <span className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${getImpactColor(decision.impact_level)}`}>
                    {decision.impact_level}
                  </span>
                </div>
                ...
                <div className="flex items-center gap-2 mb-3">
                  <span className={`inline-flex px-2 py-1 text-xs rounded ${getTypeColor(decision.decision_type)}`}>
                    {decision.decision_type}
                  </span>
                  <span className={`inline-flex px-2 py-1 text-xs rounded ${getReversibilityColor(decision.reversibility)}`}>
            ...
            <div className="flex items-center justify-between pt-4 border-t">
              ...
              <div className="flex space-x-2">
                <select
                  ...
                  className={`text-xs font-semibold rounded px-2 py-1 border-none ${getStatusColor(decision.status)}`}
                >
                  <option value="PROPOSED">Proposed</option>
                  <option value="APPROVED">Approved</option>
                  <option value="IMPLEMENTED">Implemented</option>
            ...
            <div className="flex justify-between items-start mb-6">
              <div>
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <span className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${getImpactColor(selectedDecision.impact_level)}`}>
                ...
                <div className="flex items-center gap-4 text-sm text-gray-600">
                  ...
                  <span>•</span>
                  <span className={`inline-flex px-2 py-1 text-xs rounded ${getTypeColor(selectedDecision.decision_type)}`}>
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  ...
                  <span className={`inline-flex px-2 py-1 text-xs rounded ${getReversibilityColor(selectedDecision.reversibility)}`}>

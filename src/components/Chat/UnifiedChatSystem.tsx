...
const UnifiedChatSystem: React.FC<UnifiedChatSystemProps> = ({
 ...
 className="fixed bottom-4 right-4 bg-blue-600 text-white rounded-full shadow-lg hover:bg-blue-700 transition-colors z-50"
 >
 ...
 className="w-full flex items-center justify-center space-x-2 py-2 border border-dashed border-gray-300 rounded-md text-sm text-gray-600 hover:border-gray-400 hover:text-gray-700"
 >
 ...
 className={`w-full flex items-center space-x-2 py-2 rounded-md text-left ${
 ...
 className="w-full flex items-center space-x-3 py-2 rounded-md text-left hover:bg-gray-100"
 >
 <div className="relative">
 {user.avatar_url ? (
 ...
 <button
 type="submit"
 className="border border-transparent rounded-md text-sm font-medium text-white bg-blue-600 hover:bg-blue-700"
 >
 Create Channel
 </button>
 </div>

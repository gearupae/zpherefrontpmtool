            ...
            {estimate ? (
              <div className="space-y-4">
                ...
                <div className="flex items-center space-x-4">
                  <span className={`inline-flex px-2 py-1 rounded-full text-xs font-medium ${getConfidenceColor(estimate.confidence_level)}`}>
                    {estimate.confidence_level.replace('_', ' ')} confidence
                  </span>
                  <span className={`inline-flex px-2 py-1 rounded-full text-xs font-medium ${getComplexityColor(estimate.complexity_level)}`}>
